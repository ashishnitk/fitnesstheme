...
export const getCartTotal = cartItems => {
    ...
    for(var i=0; i<cartItems.length; i++){
        total += parseInt(cartItems[i].qty, 10)*parseFloat(cartItems[i].price - (cartItems[i].price*cartItems[i].discount/100).toFixed(2), 10);
    }
...
// Get Feature Products
export const getLatestFiveProducts = (products) => {
