    ...
    CreateConsumerId = () => {
        ...
        if (this.validator.allValid()) {
            ...
            let data = {
                ...
                isHomeAddress: this.state.isHomeAddress
            }
            axiosInstance({
                method: 'post',
                url: `${configData.NEW_API_URL}/Guests/checkout`,
                data: data,
                headers: {
    ...
    render (){
        ...
        return (
            <div>
                ...
                {/*SEO Support*/}
                <Helmet>
                    <title>{userProfile.name} | CheckOut Page</title>
                                    ...
                                    <div className="checkout row">
                                        <div className="col-lg-12 col-sm-12 col-xs-12">
                                            ...
                                            <div className="row check-out">
                                                ...
                                                <div className="form-group col-md-6 col-sm-6 col-xs-12">
                                                    <div className="field-label">Alternate Mobile Number</div>
                                                    <input type="text" name="alt-phone"  value={this.state.altphone} onChange={this.setStateFromInput} />
                                                    {this.validator.message('alt-phone', this.state.altphone, 'phone')}
                                                </div>
                                                <div className="form-group col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div className="form-group col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="text" name="country" value={this.state.country} onChange={this.setStateFromInput} />
                                                ...
                                                <div className="form-group col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <input type="text" name="landmark" value={this.state.landmark} onChange={this.setStateFromInput} placeholder="Landmark" />
                                                    {this.validator.message('landmark', this.state.landmark, 'min:20|max:120')}
                                                </div>
                                                <div className="form-group col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div className="text-right">
                                                        <button type="button" className="btn-solid btn" onClick={() => this.CreateConsumerId()} >Proceed</button>
                                                </div>
                                                </div>
                                        </div>
