...
class DetailsWithPrice extends Component {
    ...
    render (){
        const {symbol, item, addToCartClicked, BuynowClicked, addToWishlistClicked, url} = this.props
        ...
        return (
            <div className="col-lg-6 rtl-text">
                <div className="product-right">
                    <h2> {item.name} </h2>
                    {item.discount?  <h4><del>{symbol}{item.price}</del>
                        <span>{item.discount}% off</span></h4>
                                : ""
                                }
                    {item.price ? <h3>{symbol}{item.price-(item.price*item.discount/100)}</h3> :
                    ...
                    <div className="border-product">
                        ...
                        <div className="product-icon">
                            <ul className="product-social">
                                <li><a href={`https://www.facebook.com/sharer/sharer.php?u=${url}/collection/product/${item._id}`} target="_blank"><i className="fa fa-facebook"></i></a></li>
                                <li><a href={`https://plus.google.com/share?url=${url}/collection/product/${item._id}`} target="_blank"><i className="fa fa-google-plus"></i></a></li>
                                <li><a href={`https://twitter.com/intent/tweet?text=Check+out+&url=${url}/collection/product/${item._id}`} target="_blank"><i className="fa fa-twitter"></i></a></li>
