                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/contact`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/about-us`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`${process.env.PUBLIC_URL}/faq`} target="_blank">
